...
base_a.2 <-subset(base_a.2,base_a.2$Sexo=="Mujer")
...
base_b <-subset(base_b,base_b$Sexo=="Mujer")
...
base_c.2 <-subset(base_c.2,base_c.2$Sexo=="Mujer")
...
base_d.2 <-subset(base_d.2,base_d.2$Sexo=="Mujer")
...
base_completa_m <- cbind(base_ciudad_montana,datos_percep)
