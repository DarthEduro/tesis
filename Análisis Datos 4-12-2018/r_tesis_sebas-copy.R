...
data <- read.table("Base de datos Testo y CSS_Ciudad_Monta?a_2018.csv", sep=",", header=T)
...
####Analisis exploratorio de la relaci? de la testosterona con las diferentes variables###
