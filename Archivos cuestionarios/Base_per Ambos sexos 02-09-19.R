#### Oganizar base de datos de Q.A 30/08/19##

getwd()
setwd("C:/Google Drive/Proyectos/Proyectos Seleccion Sexual, Hormonas y Morfometrias/Tessoterona y Morfos/BDD 02-09-19")
...
base_completa <- cbind(base_ciudad_montana,datos_percep)
